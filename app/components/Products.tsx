...
const products = [
  {
    ...
    description: "Résistances de four, plaques chauffantes et éléments tubulaires pour toutes marques professionnelles.",
    tags: ["Four", "Grill", "Salamandre"],
    icon: (
  ...
  },
  {
    ...
    tags: ["Lavage", "Séchage", "Industriel"],
    icon: (
      <svg className="w-10 h-10" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description: "Joints de porte, garnitures de hublot, joints toriques et presses-étoupes pour toutes applications professionnelles.",
    tags: ["Porte", "Hublot", "Étanchéité"],
    icon: (
      <svg className="w-10 h-10" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description: "Électrovannes d'alimentation, vannes de régulation, clapets anti-retour pour machines professionnelles.",
    tags: ["Eau", "Vapeur", "Régulation"],
    icon: (
      <svg className="w-10 h-10" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
